...
def main():
    ...
    with open('fixed_sync_result.json', 'w', encoding='utf-8') as f:
        json.dump(result, f, ensure_ascii=False, indent=2)
    
    with open('fixed_raw_data.json', 'w', encoding='utf-8') as f:
        json.dump(all_data, f, ensure_ascii=False, indent=2)
    
    print("\n📄 结果已保存:")
    print("   fixed_sync_result.json - 汇总结果")
    print("   fixed_raw_data.json - 原始数据")
